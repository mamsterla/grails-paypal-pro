...
class PayPalProTagLib {
    ...
    def generateAutoHideJavascript = { attrs ->
    ...
    private createPluginResourceSrc(fileName) {
        return g.createLinkTo(dir: pluginContextPath, file: fileName)
    }

    def cardTypeSelect = { attrs ->
    ...
    static final Map COUNTRY_CODES = [
        AF: "AFGHANISTAN",
        AX: "ALAND ISLANDS",
        AL: "ALBANIA",
        DZ: "ALGERIA",
